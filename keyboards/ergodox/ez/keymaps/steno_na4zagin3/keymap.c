...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LGUI,        KC_GRV,       KC_INS, KC_PSCR,KC_NO,
                                               KC_HOME,        KC_END,
                                                               KC_LALT,
                                               KC_DELT,KC_SPC, KC_LCTRL,
        // right hand
             KC_RGHT,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             KC_MINS,
             KC_LBRC,     KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_RBRACKET,
                          KC_H,   KC_J,   KC_K,   KC_L,   LT(MDIA, KC_SCLN),KC_QUOT,
             TG(TXBOLT),  KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
...
[TXBOLT] = KEYMAP(
    ...
    TG(TXBOLT2), M(NM),   M(NM),   M(NM),   M(NM),   M(NM),   M(NM),
